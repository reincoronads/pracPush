...
public class registerPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        login.add(userPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 70, 320, 70));
        ...
        login.add(typeBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 270, 330, 90));
        ...
        passPane.add(passLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 90, -1));
        ...
        login.add(passPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, 320, 70));
    ...
    private void submitbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_submitbtnMouseClicked
        ...
        String query = "INSERT INTO client_tbl (client_Fname, client_Lname, client_Address, client_Email, client_Phone, client_user, client_pass, client_status, client_type) "
                     + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = dbc.getConnection();
            ...
            pst.setString(9, (String) typeComboBox.getSelectedItem()); // client_type
